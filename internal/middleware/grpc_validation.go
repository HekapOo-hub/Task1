...
func WithUnaryServerValidationInterceptor() grpc.ServerOption {
	return grpc.UnaryInterceptor(unaryServerValidationInterceptor)
}

func WithStreamServerValidationInterceptor() grpc.ServerOption {
